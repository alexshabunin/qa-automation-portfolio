...
How the tests in this repo are built. Opinionated; the reasons are short.

## 1. assertions are load-bearing

Every failure carries the information a future me needs to fix it without
re-running the test.
...
## 2. locators are a contract, not a guess
...
## 6. fixture scope is the engineering decision
...
These rules don't change the way I write the *next* test — they're the
reason the previous 43 don't flake.
